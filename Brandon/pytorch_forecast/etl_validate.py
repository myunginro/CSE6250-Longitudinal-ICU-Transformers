...
validate_label_df = pd.read_csv('../val_listfile_by.csv')
df = pd.DataFrame()

row_1 = validate_label_df.iloc[0]
...
for index, row in validate_label_df.iterrows():
...
print(df)
df.to_csv('validate_timeseries.csv')
